  ...
  return (
    <main className="w-full md:w-[60%] md:px-0 px-5 mx-auto">
      ...
      <Section>
        ...
        <div className="my-10">
          <p className="pb-5">
            Hi there! I'm Ryan, a software developer who's super into mobile
            development. I started my tech journey in 2021 and have been loving
            every minute of it. I enjoy learning new technologies and am always
            excited about the next big thing in tech. This journey has been an
            amazing ride, and I'm passionate about creating cool and innovative
            solutions along the way.
          </p>

          <p>
            At first, coding was just a hobby, but now it's part of my daily
            routine. Sure, sometimes it gets a bit boring, so I mix things up by
            watching movies, hitting the gym, and playing games. I'm also into
            learning new things, like playing football and figuring out cool
            tactics. It's all about keeping things interesting and having fun
            along the way!
          </p>
        </div>
      </Section>
